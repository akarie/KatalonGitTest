...
WebUI.setText(findTestObject('Object Repository/New Subscription/Page_Add New Subscription - PraisindoSIARUI/input__product'), 
    'ADE')
...
WebUI.setText(findTestObject('New Subscription/Page_Add New Subscription - PraisindoSIARUI/input__NetAmount'), '10000000.9999')
...
not_run: WebUI.click(findTestObject('Object Repository/New Subscription/Page_Add New Subscription - PraisindoSIARUI/input_Fee ()_FeePercentage'))

not_run: WebUI.setText(findTestObject('New Subscription/Page_Add New Subscription - PraisindoSIARUI/input_Fee ()_FeePercentage'), 
    '4')
